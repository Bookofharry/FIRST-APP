    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, sql(templateObject_1 || (templateObject_1 = __makeTemplateObject(["SELECT * FROM revenue"], ["SELECT * FROM revenue"])))];
                case 1:
                    data = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    data = _a.sent();
                    latestInvoices = data.map(function (invoice) { return (__assign(__assign({}, invoice), { amount: utils_1.formatCurrency(invoice.amount) })); });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    _e.trys.push([0, 2, , 3]);
                    invoiceCountPromise = sql(templateObject_3 || (templateObject_3 = __makeTemplateObject(["SELECT COUNT(*) FROM invoices"], ["SELECT COUNT(*) FROM invoices"])));
                    customerCountPromise = sql(templateObject_4 || (templateObject_4 = __makeTemplateObject(["SELECT COUNT(*) FROM customers"], ["SELECT COUNT(*) FROM customers"])));
                    invoiceStatusPromise = sql(templateObject_5 || (templateObject_5 = __makeTemplateObject(["SELECT\n         SUM(CASE WHEN status = 'paid' THEN amount ELSE 0 END) AS \"paid\",\n         SUM(CASE WHEN status = 'pending' THEN amount ELSE 0 END) AS \"pending\"\n         FROM invoices"], ["SELECT\n         SUM(CASE WHEN status = 'paid' THEN amount ELSE 0 END) AS \"paid\",\n         SUM(CASE WHEN status = 'pending' THEN amount ELSE 0 END) AS \"pending\"\n         FROM invoices"])));
                ...
                case 1:
                    data = _e.sent();
                    numberOfInvoices = Number((_a = data[0][0].count) !== null && _a !== void 0 ? _a : '0');
                    numberOfCustomers = Number((_b = data[1][0].count) !== null && _b !== void 0 ? _b : '0');
                    totalPaidInvoices = utils_1.formatCurrency((_c = data[2][0].paid) !== null && _c !== void 0 ? _c : '0');
                    totalPendingInvoices = utils_1.formatCurrency((_d = data[2][0].pending) !== null && _d !== void 0 ? _d : '0');
                    return [2 /*return*/, {
...
function fetchInvoicesPages(query) {
    return __awaiter(this, void 0, void 0, function () {
        var data, totalPages, error_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, sql(templateObject_7 || (templateObject_7 = __makeTemplateObject(["SELECT COUNT(*)\n    FROM invoices\n    JOIN customers ON invoices.customer_id = customers.id\n    WHERE\n      customers.name ILIKE ", " OR\n      customers.email ILIKE ", " OR\n      invoices.amount::text ILIKE ", " OR\n      invoices.date::text ILIKE ", " OR\n      invoices.status ILIKE ", "\n  "], ["SELECT COUNT(*)\n    FROM invoices\n    JOIN customers ON invoices.customer_id = customers.id\n    WHERE\n      customers.name ILIKE ", " OR\n      customers.email ILIKE ", " OR\n      invoices.amount::text ILIKE ", " OR\n      invoices.date::text ILIKE ", " OR\n      invoices.status ILIKE ", "\n  "])), "%" + query + "%", "%" + query + "%", "%" + query + "%", "%" + query + "%", "%" + query + "%")];
                case 1:
                    data = _a.sent();
                    totalPages = Math.ceil(Number(data[0].count) / ITEMS_PER_PAGE);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    data = _a.sent();
                    invoice = data.map(function (invoice) { return (__assign(__assign({}, invoice), { 
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    data = _a.sent();
                    customers = data.map(function (customer) { return (__assign(__assign({}, customer), { total_pending: utils_1.formatCurrency(customer.total_pending), total_paid: utils_1.formatCurrency(customer.total_paid) })); });
                    return [2 /*return*/, customers];
                case 2:
                    err_2 = _a.sent();
